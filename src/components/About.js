...
import VAMSHI from './images/VAMSHI.jpg';
        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-md-3">
            <div className="card mb-4 d-flex flex-column text-center" style={{ border: 'none' }}>
              <img src={VAMSHI} className="card-img-top rounded-circle" alt="Sumeet Wadile" />
              <div className="card-body">
                <h5 className="card-title">PASUPULETI VAMSHI KARTHIK</h5>
          ...
          <div className="col-md-3">
            <div className="card mb-4 d-flex flex-column text-center" style={{ border: 'none' }}>
              <img src={Tharun} className="card-img-top rounded-circle" alt="Sujit Pawar" />
              <div className="card-body">
                <h5 className="card-title">SRINIVAS THARUN</h5>
                <p className="card-text">Admin</p>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card mb-4 d-flex flex-column text-center" style={{ border: 'none' }}>
              <img src={Karthik} className="card-img-top rounded-circle" alt="Sumedh Shingade" />
              <div className="card-body">
                <h5 className="card-title">SRINIVAS KARTHIKEYA</h5>
                <p className="card-text">Admin</p>
              </div>
            </div>
          </div>
